<html>
	<?php 
		...
		?>
		<table border="1">
			<tr><th>Nom</th><th>Prénom</th><th>Civilité</th><th>Adresse</th><th>CP</th><th>Ville</th><th>Date de naissance</th><th>Lieu de naissance</th><th>Numéro de sécu</th><th>Prendre RDV</th><th>Modifier</th><th>Supprimer</th></tr>
		<?php
		...
		?>
			 	<tr>
					...
					<td><a href="ajoutRDV.php?id_usager=<?php echo $data['id_usager'];?>">oui</a></td> 
